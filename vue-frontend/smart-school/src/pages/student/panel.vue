<template>
    <el-row :gutter="20" class="mb-5 mt-10">
        ...
        <el-col :span="6" :offset="0" v-for="(item, index) in list" :key="index">
            <el-card shadow="never">
                <div class="flex items-center" >
                    <el-icon :size="20"  :style="{backgroundColor:item.color}" class="text-white w-[40px] h-[50px] rounded-full" >
                        <WarningFilled v-if="index == 0"/>
...
loading.value = true
get_student_statistics().then(res => {
